...
export default function Hub() {
  ...
  const hasBoth    = showCosiri && showGmp;
    ...
    <AppLayout>
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          ...
          {hasBoth && " · COSIRI + GMP active"}
        </p>
      </div>

      {/* ── Combined KPI banner (both modules) ── */}
      {hasBoth && (cosiriScore != null || totalAudits > 0) && (
        <div className="mb-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className={`${card} p-4 flex flex-col gap-2`}>
            ...
            <p className="text-2xl font-display font-bold text-foreground leading-none">
              {totalAudits > 0 ? <>{avgCompliance}<span className="text-sm text-muted-foreground font-normal">%</span></> : "—"}
            </p>
            {totalAudits > 0 && (
      ...
      {/* ── Module cards ── */}
      <div className={`grid gap-6 ${hasBoth ? "grid-cols-1 lg:grid-cols-2" : "grid-cols-1 max-w-xl"}`}>
              ...
              <div className="flex flex-col gap-2 mt-auto">
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {cosiriAssessments.length === 0 ? "Start Assessment" : "New Assessment"}
                  </Link>
                  {latestCosiri && (
                    <Link
              ...
              <div className="flex flex-col gap-2 mt-auto">
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    {totalAudits === 0 ? "Start Audit" : "New Audit"}
                  </Link>
                  {latestGmpAudit && (
                    <Link
      ...
      {/* ── Module quick-jump row (both active) ── */}
      {hasBoth && (
