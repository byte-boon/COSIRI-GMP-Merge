      ...
      <div className="flex-1 flex items-center justify-center p-8 sm:p-12">
        ...
        >
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              <label className="text-sm font-medium mb-1.5 block text-foreground">Email or Username</label>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            New to the platform?{" "}
            <Link href="/register" className="text-primary font-medium hover:underline">Create a workspace</Link>
          </p>
        </motion.div>
      </div>
    </div>
